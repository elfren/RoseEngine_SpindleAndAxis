...
//	float currentSpeedPercentAxis = 1;
	...
	float overrideSpindleSpeedMultiplier = 1;
	float overrideSpeedAxisMultiplier = 1;
	...
	while (stepper_Axis_Go || stepper_Spindle_Go || stepperAxis_M3.isMoving)
	{
		...
		if (SerialAvailable() >= 0)
		{
			...
			switch (incomingByte)
			{
				...
				{
					Serial.print("1. overrideSpindleSpeedMultiplier:  ");
					Serial.println(overrideSpindleSpeedMultiplier);

					configMain.speedPercent_Spindle = (int)GetSerialFloat(serialId);
					speedPercentSpindle = (float)(configMain.speedPercent_Spindle * .01);
					newSpindleSpeed = static_cast<int32_t>(maxSpd_Spindle * direction_Spindle * configMain.speedPercent_Spindle * .01);

					overrideSpindleSpeedMultiplier = static_cast<float>(newSpindleSpeed) / static_cast<float>(currentSpindleSpeed);
					EEPROM.put(eePromAddress_Main, configMain);
					...
					Serial.print("overrideSpindleSpeedMultiplier:  ");
					Serial.println(overrideSpindleSpeedMultiplier);
					if (configMain.synchro_M3_Spindle == 1)//Synchronized M3 and Spindle
					{
						spindleM3Group.overrideSpeed(overrideSpindleSpeedMultiplier);
					}
					else
					{
						stepperSpindle.overrideSpeed(overrideSpindleSpeedMultiplier);
					}
					break;
				}
				case 111: // Axis Speed
				{
					...
					switch (configMain.axisId)
					{
						case ID_AXIS_Z:
						{
							...
							Serial.print("1.speedPercentAxis: ");
							Serial.println(speedPercentAxis);
							configMain.speedPercent_Z = newSpeedPercent;
							speedPercentAxis = (float)((newSpeedPercent) * .01);

							////newAxisSpeed = static_cast<int32_t>(maxSpeed_Axis * direction_Axis * configMain.speedPercent_Z * .01);
							newAxisSpeed = static_cast<int32_t>(maxSpeed_Axis * configMain.speedPercent_Z * .01);
							//overrideSpeedAxisMultiplier = static_cast<float>(newAxisSpeed) / static_cast<float>(currentSpindleSpeed);

							stepperAxis_Z.overrideSpeed(speedPercentAxis);
						...
						case ID_AXIS_X:
						{
							...
							newAxisSpeed = static_cast<int32_t>(maxSpeed_Axis * configMain.speedPercent_X * .01);
							overrideSpeedAxisMultiplier = static_cast<float>(newAxisSpeed) / static_cast<float>(currentSpindleSpeed);
						...
						case ID_AXIS_3:
						{
							...
							newAxisSpeed = static_cast<int32_t>(maxSpeed_Axis * configMain.speedPercent_M3 * .01);
						...
						case ID_AXIS_4:
						{
							...
							speedPercentAxis = (float)((newSpeedPercent) * .01);
							newAxisSpeed = static_cast<int32_t>(maxSpeed_Axis * configMain.speedPercent_M4 * .01);
							overrideSpeedMultiplier = static_cast<float>(newAxisSpeed) / static_cast<float>(currentSpindleSpeed);
				...
				case 226: // Switch direction
				{
					//int axisOrSpindle = (int)GetSerialFloat(serialId);
					int axisOrSpindle = GetSerialInteger();
					Serial.print("10.axisOrSpindle: ");
					Serial.println(axisOrSpindle);

					switch (axisOrSpindle)
					{
						case 10:
						case 11:
						{
							...
							{
								stepperSpindle.overrideSpeed(-1);
							}
							break;
						}
						case 20:
						case 21:
						{
							...
							case ID_AXIS_Z:
							{
								Serial.print("10.speedPercentAxis: ");
								Serial.println(speedPercentAxis);
								//configMain.speedPercent_Z = newSpeedPercent;
								//speedPercentAxis = (float)((newSpeedPercent) * .01);

								//newAxisSpeed = static_cast<int32_t>(maxSpeed_Axis * direction_Axis * configMain.speedPercent_Z * .01);
								newAxisSpeed = static_cast<int32_t>(maxSpeed_Axis * configMain.speedPercent_Z * .01 * (-1));
								//overrideSpeedMultiplier = static_cast<float>(newAxisSpeed) / static_cast<float>(currentSpindleSpeed);

								//stepperAxis_Z.overrideSpeed(overrideSpeedMultiplier);
								speedPercentAxis = speedPercentAxis * (-1);
								Serial.print("speedPercentAxis: ");
								Serial.println(speedPercentAxis);
								stepperAxis_Z.overrideSpeed(speedPercentAxis * (-1));
								break;
							}
							case ID_AXIS_X:
							{
							...
							case ID_AXIS_3:
							{
								...
								//newAxisSpeed = static_cast<int32_t>(maxSpeed_Axis * configMain.speedPercent_M3 * .01);
								//overrideSpeedMultiplier = static_cast<float>(newAxisSpeed) / static_cast<float>(currentSpindleSpeed);
								stepperAxis_M3.overrideSpeed(-1);
								break;
							}
							case ID_AXIS_4:
							{
								...
								//newAxisSpeed = static_cast<int32_t>(maxSpeed_Axis * configMain.speedPercent_M4 * .01);
								//overrideSpeedMultiplier = static_cast<float>(newAxisSpeed) / static_cast<float>(currentSpindleSpeed);
								stepperAxis_M4.overrideSpeed(-1);
								break;
							}
							}
...
void tick()
{
	...
	//Serial.print("  stepperAxis_X.getPosition(): ");
	//Serial.println(stepperAxis_X.getPosition());
	// 
#endif // VERBOSE
...
//		int spindleChecked = 16 & checkedAxis;
	...
	int idAndChecked = 0;
		...
		Serial.print("Spindle Direction: ");
...
void LoadPage_More()
{
	...
	const char* pageMore_c0_0 = "pageMore.c0.val=0";
	const char* pageMore_c0_1 = "pageMore.c0.val=1";
