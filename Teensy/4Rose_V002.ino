...
void loop()
{
	...
	if (serialId <9) // If serial data is available, parse the data
	{
		...
		case 199: // Ç - ZiZa_Z Spindle Acceleration
		{
			configSteppers.acceleration_ZiZa_Z_Spindle = GetSerialFloat(serialId);
			EEPROM.put(eePromAddress, configSteppers);
			break;
		}
		case 200: // È - ZiZa_Z Axis Acceleration
		{
			configSteppers.acceleration_ZiZa_Z_Axis = GetSerialFloat(serialId);
			EEPROM.put(eePromAddress, configSteppers);
			break;
		}
		case 201: // É - ZiZa_Z Spindle MaxSpeed 
		{
			configSteppers.maxSpeed_ZiZa_Z_Spindle = GetSerialFloat(serialId);
			EEPROM.put(eePromAddress, configSteppers);
			break;
		}
		case 202: // Ê - ZiZa_Z Axis MaxSpeed 
		{
			configSteppers.maxSpeed_ZiZa_Z_Axis = GetSerialFloat(serialId);
			EEPROM.put(eePromAddress, configSteppers);
			break;
		}
		case 203: // Ì - ZiZa_Z Repeats (Count)
		{
			configSteppers.repeats_ZiZa_Z = GetSerialFloat(serialId);
			EEPROM.put(eePromAddress, configSteppers);
			break;
		}
		case 204: // Ë - ZiZa_Z Distance
		{
			configSteppers.distance_ZiZa_Z = GetSerialFloat(serialId);
			EEPROM.put(eePromAddress, configSteppers);
			break;
		}

		case 205: // Í - ZiZa_Z Amplitude
		{
			configSteppers.amplitude_ZiZa_Z = GetSerialFloat(serialId);
			EEPROM.put(eePromAddress, configSteppers);
			break;
		}
		case 206: // Î - ZiZa_Z Return
		{
			Return_ZigZag_Z();
			break;
		}
		// ---------ZigZag_SpZ
		case 207: // Ï - Do ZigZag_SpZ 
		{
			...
			DoZigZag_SpZ(waveDir);
			break;
		}
		case 208: // Ð - ZigZag_SpZ Spindle Acceleration
		{
			configSteppers.acceleration_ZigZag_SpZ_Spindle = GetSerialFloat(serialId);
			EEPROM.put(eePromAddress, configSteppers);
			break;
		}
		case 209: // È - ZigZag_SpZ Axis Acceleration
		{
			configSteppers.acceleration_ZigZag_SpZ_Axis = GetSerialFloat(serialId);
			EEPROM.put(eePromAddress, configSteppers);
			break;
		}
		case 210: // É - ZigZag_SpZ Spindle MaxSpeed 
		{
			configSteppers.maxSpeed_ZigZag_SpZ_Spindle = GetSerialFloat(serialId);
			EEPROM.put(eePromAddress, configSteppers);
			break;
		}
		case 211: // Ê - ZigZag_SpZ Axis MaxSpeed 
		{
			configSteppers.maxSpeed_ZigZag_SpZ_Axis = GetSerialFloat(serialId);
			EEPROM.put(eePromAddress, configSteppers);
			break;
		}
		case 212: // Ì - ZigZag_SpZ Repeats (Count)
		{
			configSteppers.repeats_ZigZag_SpZ = GetSerialFloat(serialId);
			EEPROM.put(eePromAddress, configSteppers);
			break;
		}
		case 213: // Ë - ZigZag_SpZ Distance
		{
			configSteppers.degrees_ZigZag_SpZ = GetSerialFloat(serialId);
			EEPROM.put(eePromAddress, configSteppers);
			break;
		}

		case 214: // Í - ZigZag_SpZ Amplitude
		{
			configSteppers.amplitude_ZigZag_SpZ = GetSerialFloat(serialId);
			EEPROM.put(eePromAddress, configSteppers);
			break;
		}
		case 215: // Î - ZigZag_SpZ Return
		{
			Return_ZigZag_SpZ();
			break;
		}
