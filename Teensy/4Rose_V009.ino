...
void loop()
{
	// ToDo: Add serial port selection to Nextion Setup page
	...
	if (serialId <9) // If serial data is available, parse the data
	{
		...
		case 88:  // X - Update Index1 size
		{
			...
			{
				configIndex_1.size = (configMain.microsteps_Spindle * configMain.steps360_Spindle * configMain.gearRatio_Spindle) / (newIndexSize);
			}
		...
		case 90:  // Z - Main Axis Clockwise
		{
			...
			//RunTwoSteppers_All(DIR_CW, DIR_CW, ID_AXIS_Z, ID_AXIS_Z);
			break;
		}
		case 91:  // [ - Z Axis Counterclockwise
		{
			RunTwoSteppers_Sp_Axis(DIR_CCW, DIR_CCW, ID_AXIS_Z, ID_AXIS_Z);
			//RunTwoSteppers_All(DIR_CCW, DIR_CCW, ID_AXIS_Z, ID_AXIS_Z);
			break;
		}
		case 92: // \ - *** Don't Use***
		{
		...
		case 107: // k - Z Spindle Clockwise
		{
			...
			//RunTwoSteppers_All(DIR_CW, DIR_CW, ID_SPINDLE, ID_AXIS_Z);
			break;
		}
		case 108: // l - Z spindle counter clockwise
		{
			...
			//RunTwoSteppers_All(DIR_CCW, DIR_CCW, ID_SPINDLE, ID_AXIS_Z);
			break;
		}
		case 109: // m - //Not used
		{
		...
		case 110: // n - Set SpZ (Main) Spindle Speed
		{
			...
			EEPROM.put(eePromAddress_Setup, configMain);
#ifdef DEBUG
			Serial.print("speedPercentSpindle_Main:");
		...
		case 111: // o - Rose: Speed Percentage Z Axis 
		{
			if (configRose.axisId == ID_AXIS_Z)
			{
				...
				Serial.println(configRose.speedPercent_Axis_Z);
#endif // DEBUG
			}
			else
			{
...
#ifdef DEBUG
				Serial.print("speedPercent_Axis:");
				Serial.println(configRose.speedPercent_Axis_X);
#endif // DEBUG
			}
...
//#endif // FOUR_AXES
...
#endif // end RUN_OLD
#ifdef RUN_ALL
			RunTwoSteppers_All(DIR_CCW, DIR_CCW, ID_SPINDLE, ID_AXIS_X);
#endif // end RUN_ALL
			break;
		}
...
#endif // end RUN_OLD
#ifdef RUN_ALL
			RunTwoSteppers_All(DIR_CW, DIR_CW, ID_SPINDLE, ID_AXIS_X);
#endif // end RUN_ALL
			break;
		}
		...
		{
#ifdef DEBUG
			Serial.println("case 165:DIR_CW, DIR_CW, ID_AXIS_X, ID_AXIS_X");
#endif // DEBUG
...
#endif // end RUN_OLD
#ifdef RUN_ALL
			RunTwoSteppers_All(DIR_CW, DIR_CW, ID_AXIS_X, ID_AXIS_X);
#endif // end RUN_ALL
			break;
		}
...
#endif // end RUN_OLD
#ifdef RUN_ALL
			RunTwoSteppers_All(DIR_CCW, DIR_CCW, ID_AXIS_X, ID_AXIS_X);
#endif // end RUN_ALL
			break;
		}
...
#endif // end RUN_OLD
#ifdef RUN_ALL
			RunTwoSteppers_All(DIR_CCW, DIR_CCW, ID_SPINDLE, ID_AXIS_B);
#endif // end RUN_ALL
			break;
		}
...
#endif // end RUN_OLD
#ifdef RUN_ALL
			RunTwoSteppers_All(DIR_CW, DIR_CW, ID_SPINDLE, ID_AXIS_B);
#endif // end RUN_ALL
			break;
		}
...
#endif // end RUN_OLD
#ifdef RUN_ALL
			RunTwoSteppers_All(DIR_CCW, DIR_CCW, ID_AXIS_B, ID_AXIS_B);
#endif // end RUN_ALL
			break;
		}
...
#endif // end RUN_OLD
#ifdef RUN_ALL
			RunTwoSteppers_All(DIR_CW, DIR_CW, ID_AXIS_B, ID_AXIS_B);
#endif // end RUN_ALL
			break;
		}
		//case 173: // Don't use 
		...
		case 200: // È - Greek Key: Spindle Accel
		{
			...
			switch (configGreekKey_Main.axisId)
			{
				case 0: // Greek Key Z: Spindle accel
				//case 48:
				{
				...
				case 1: // Greek Key X: Spindle accel
				//case 49:
				{
		...
		case 230: // å - Greek Key File: Pattern Count/360
		{
			...
			int retVal = (int)GetSerialFloat(serialId);
			configGreekKey_Main.countPatternFile360 = retVal;
			EEPROM.put(eePromAddress_GreekKey_Main, configGreekKey_Main);
#ifdef DEBUG
		...
		case 250: // ù -Greek Key: Axis Accel
		{
			...
			switch (configGreekKey_Main.axisId)
			{
				case 0: // Greek Key Z: Z Axis accel
				case 49:
				{
		...
		{
			configGreekKey_Main.countPattern360 = GetSerialInteger();// (int)GetSerialFloat(serialId);
			EEPROM.put(eePromAddress_GreekKey_Main, configGreekKey_Main);
#ifdef DEBUG
