...
void setup()
{
	...
	if (sdValid)
	{
	////	SerialPrint("pageIndexF2.vaDisplayFile.val=1"); // Nextion may not get the first packet
	////	Serial1.write(0xff);
	////	Serial1.write(0xff);
	////	Serial1.write(0xff);
	////	delay(50);
	...
	{
	////	SerialPrint("pageIndexF2.vaDisplayFile.val=0"); // Nextion may not get the first packet
	////	Serial1.write(0xff);
	////	Serial1.write(0xff);
	////	Serial1.write(0xff);
	////	delay(50);
