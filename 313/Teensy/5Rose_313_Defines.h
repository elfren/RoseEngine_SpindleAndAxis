...
struct configPageMov
{
	...
	uint32_t maxSpd_Z;
	uint32_t accel_Z;
	uint32_t speedPercent_Z;
	uint32_t maxSpd_X;
	uint32_t accel_X;
	uint32_t speedPercent_X;
	uint32_t maxSpd_M3;
	uint32_t accel_M3;
	uint32_t speedPercent_M3;
	uint32_t maxSpd_M4;
	uint32_t accel_M4;
	uint32_t speedPercent_M4;
...
struct configPageSetup
{
	...
	uint32_t microsteps_Z;
	uint32_t steps360_Z;
	float distancePerRev_Z;
	uint32_t limit_Min_Z;
	uint32_t limit_Max_Z;
	uint32_t microsteps_X;
	uint32_t steps360_X;
	float distancePerRev_X;
	uint32_t limit_Min_X;
	uint32_t limit_Max_X;
	uint32_t radialOrLinear_M3;
	uint32_t microsteps_M3;
	uint32_t steps360_M3;
	float gearRatio_M3;
	float distancePerRev_M3;
	float radiusM3;
	uint32_t limit_Min_M3;
	uint32_t limit_Max_M3;

	uint32_t radialOrLinear_M4;
	uint32_t microsteps_M4;
	uint32_t steps360_M4;
	float gearRatio_M4;
	float distancePerRev_M4;
	float radiusM4;
	...
	uint32_t maxSpd_Return_Z;
	uint32_t accel_Return_Z;
	uint32_t maxSpd_Return_X;
	uint32_t accel_Return_X;
	uint32_t maxSpd_Return_M3;
	uint32_t accel_Return_M3;

	uint32_t maxSpd_Return_M4;
	uint32_t accel_Return_M4;
	...
	uint32_t leadscrewHand_Z;
	uint32_t leadscrewHand_X;
	uint32_t leadscrewHand_AltX;
	uint32_t leadscrewHand_M3;
	uint32_t leadscrewHand_M4;
	...
	uint32_t xAltX;
	uint32_t microsteps_XAlt;
	uint32_t steps360_XAlt;
	float distancePerRev_XAlt;
	bool polarity_XAlt;
	uint32_t keepSteppersEnabled;
	uint32_t keepSpindleEnabled;
	uint32_t keepZEnabled;
	uint32_t keepXEnabled;
	uint32_t keepM3Enabled;
	uint32_t keepM4Enabled;
...
struct configPageMainMulti  // page 20 (pageMulti),page 0 (pageMain), page 2(One)
{
	...
	int32_t speedPercent_Z;
	int32_t speedPercent_X;
	int32_t speedPercent_M3;
	int32_t speedPercent_M4;
